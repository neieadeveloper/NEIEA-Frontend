jQuery(document).ready(function ($) {
	...
	$('.offcanvas .navbar-nav .dropdown-toggle').on('click', function(e) {
		e.preventDefault();
		e.stopPropagation();
		...
		// Close all other dropdowns in mobile menu
		$('.offcanvas .navbar-nav .dropdown-menu').removeClass('show');
		$('.offcanvas .navbar-nav .dropdown-toggle').attr('aria-expanded', 'false');
